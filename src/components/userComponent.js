class VehicleGalleryComponent extends HTMLElement {
    ...
    render() {
      ...
      this.shadowRoot.innerHTML = `
        <style>
          ...
          /* Ajustamos el contenedor del 3D para que no ocupe todo el alto */
          .model3d-container {
            height: 180px;
            overflow: hidden;
            background: #000;
        ...
        <div class="modal" id="modal">
          <div class="modal-content">
            ...
            <form id="configForm" class="config-form">
              ...
              <label for="aeroLoad">Carga Aerodinámica:</label>
              <select id="aeroLoad" required>
                <option value="" disabled selected>Seleccione</option>
                <option value="baja">Baja</option>
            ...
            ? this.configurations.map((config, index) => `
                <div class="config-item" data-index="${index}">
                  <div>
                    ...
                    <p><strong>Carga Aerodinámica:</strong> ${config.aeroLoad}</p>
                    <p><strong>Estrategia:</strong> ${config.strategy}</p>
                  </div>
    ...
    handleConfigSubmit(event) {
      ...
      const config = {
        ...
        aeroLoad: this.shadowRoot.getElementById('aeroLoad').value,
        strategy: this.shadowRoot.getElementById('strategy').value
